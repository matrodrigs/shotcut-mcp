...
SERVER_INSTRUCTIONS = (
    ...
    "moment. For readiness, validate_project checks saved resources, required MLT "
    "services, and first-frame processing. Before planning, editing, or restoring, "
    "inspect the project and pass its "
